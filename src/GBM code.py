...
for col_sample in (0.7, 1):#baseline is 1
    for row_sample in (0.5, 0.9, 1): #baseline is 0.9
        for g in (0, 5, 10): #baseline is 0
            for eta in (0.05, 0.1, 0.3): #baseline is 0.3
...
#[1, 0.5, 5, 0.3, 6, 5, 0.9606, 0.9585]
#[1, 1, 0, 0.3, 6, 5, 0.9634, 0.9585]
